<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<div class="humberger__menu__wrapper">
		...
		<nav class="humberger__menu__nav mobile-menu">
			<ul>
				<li class="active"><a href="${root}/shopping" data-link>Home</a></li>
				<!-- <li><a href="${root}/shopping" data-link>Shop</a></li> -->
				<li><a href="#" >Pages</a>
					<ul class="header__menu__dropdown">
						<li><a href="${root}/shopping" data-link>Shopping</a></li>
						<li><a href="${root}/shopping/cart" data-link>Shopping Cart</a></li>
						<li><a href="${root}/checkout" data-link>Check Out</a></li>
						<!-- <li><a href="${root}/shopping" data-link>Blog Details</a></li> -->
					</ul>
				</li>
				<li><a href="${root}/shopping/cart" data-link>Shopping Cart</a></li>
				<li><a href="${root}/checkout" data-link>Checkout</a></li>
			</ul>
		</nav>
						...
						<ul>
							...
							<li><a href="#">Pages</a>
								<ul class="header__menu__dropdown">
									...
									<li><a href="${root}/shopping/cart" data-link>Shopping Cart</a></li>
									<li><a href="${root}/checkout" data-link>Check Out</a></li>
									<!-- <li><a href="${root}/shopping" data-link>Blogping</a></li> -->
								</ul>
							</li>
							<li><a href="${root}/shopping/cart" data-link>Shopping Cart</a></li>
							<li><a href="${root}/checkout" data-link>Check Out</a></li>
